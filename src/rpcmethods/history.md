...
* Aggregated view of the logs on time bases
* Access to the latest recorded signal value
* Systematic retrieval of records (for other histories to use)
* Systematic retrieval of file logs (for other histories to use)
