...
### Known time jump
A known time jump is detected on the device when the difference between system time and monotonic time suddenly doesn't correspond to the time difference when the last record was written.
